...
<!--
Describe how people would benefit from this modeling rule. This will be included in the user documentation (cf. [example](https://github.com/camunda/bpmnlint-plugin-camunda/blob/main/docs/rules/avoid-lanes.md)).
-->
